hier_linearSD_k<-function(year0,no.years, age1, L, l, k.reparam, sigma.start,No.comp, Lengths,niter,rel.tolerance)
  
{
  ...
  #compile("hier_ck_LSD.cpp")
  #compile("hier_ck_LSD_OBSLL.cpp")
  ...
  for(k in 1:niter){ 
    ...
    obj_LL <- MakeADFun(
      ...
      DLL = "hier_ck_LSD_OBSLL",silent=T)
