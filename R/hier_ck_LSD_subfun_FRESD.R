hier_linearSD_k_FRESD<-function(year0,no.years, age1, L, l, k.reparam, sigma.start,No.comp, Lengths,niter,rel.tolerance,sdl,sdk)
  
{
  ...
  for(k in 1:niter){ 
    ...
    obj_LL <- MakeADFun(
      ...
      DLL = "hier_ck_LSD_OBSLL",silent=T,hessian = T)
