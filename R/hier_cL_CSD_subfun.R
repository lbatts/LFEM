hier_constantSD_L<-function(year0,no.years, age1, L, l, k.reparam, sigma.start,No.comp, Lengths,niter,rel.tolerance)
  ...
  #compile("hier_model_version_constantSD_adj.cpp")
  #compile("hier_model_version_constantSD_OBSLL_adj.cpp")
  dyn.load(dynlib(paste0(dllroot,"hier_model_version_constantSD_adj")))
  dyn.load(dynlib(paste0(dllroot,"hier_model_version_constantSD_OBSLL_adj")))
...
print(k)
  ...
  obj_LL <- MakeADFun(
    ...
    DLL = "hier_model_version_constantSD_OBSLL_adj",
  ...
  -obj_LL$fn(obj_LL$par)[1]
    ...
    if(k > 2 ){
       ...
       obj <- MakeADFun(
         ...
         DLL = "hier_model_version_constantSD_adj",silent=T)
